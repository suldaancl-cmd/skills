...
> Codex import: this local copy is namespaced as `od-frame-glitch-title` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/frame-glitch-title`.
