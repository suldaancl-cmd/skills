---
name: od-after-hours-editorial-template
description: |
...
> Codex import: this local copy is namespaced as `od-after-hours-editorial-template` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/after-hours-editorial-template`.
