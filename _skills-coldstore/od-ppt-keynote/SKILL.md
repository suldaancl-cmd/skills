...
> Codex import: this local copy is namespaced as `od-ppt-keynote` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/ppt-keynote`.
