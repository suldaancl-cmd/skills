...
> Codex import: this local copy is namespaced as `od-image-enhancer` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/image-enhancer`.
