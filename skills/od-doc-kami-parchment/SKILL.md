...
> Codex import: this local copy is namespaced as `od-doc-kami-parchment` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/doc-kami-parchment`.
