...
> Codex import: this local copy is namespaced as `od-hand-drawn-diagrams` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/hand-drawn-diagrams`.
