...
> Codex import: this local copy is namespaced as `od-video-hyperframes` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/video-hyperframes`.
