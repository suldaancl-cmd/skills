...
> Codex import: this local copy is namespaced as `od-article-magazine` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/article-magazine`.
