...
> Codex import: this local copy is namespaced as `od-faq-page` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/faq-page`.
