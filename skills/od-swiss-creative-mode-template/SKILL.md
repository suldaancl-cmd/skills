---
name: od-swiss-creative-mode-template
description: |
...
> Codex import: this local copy is namespaced as `od-swiss-creative-mode-template` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/swiss-creative-mode-template`.
