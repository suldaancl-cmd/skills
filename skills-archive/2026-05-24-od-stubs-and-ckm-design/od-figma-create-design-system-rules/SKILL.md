---
name: od-figma-create-design-system-rules
description: |
...
> Codex import: this local copy is namespaced as `od-figma-create-design-system-rules` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/figma-create-design-system-rules`.
