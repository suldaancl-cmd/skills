...
<!-- endor_agent_kit_managed=true agent_id=sca-remediation host=antigravity -->

# SCA Remediation

Generated from Endor Agent Kit recipe `sca-remediation` v0.1.0 for Endor Labs Agent Kit Antigravity CLI plugin subagent.
