---
name: od-deck-swiss-international
zh_name: "瑞士国际主义 Deck"
...
> Codex import: this local copy is namespaced as `od-deck-swiss-international` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/deck-swiss-international`.
