...
> Codex import: this local copy is namespaced as `od-theme-factory` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/theme-factory`.
