...
<!-- endor_agent_kit_managed=true agent_id=remediation-planning agent_name=endor-remediation-planning-agent host=cursor-sdk -->

Generated from Endor Agent Kit recipe `remediation-planning` v0.1.0 for Cursor Python SDK automation.
