...
> Codex import: this local copy is namespaced as `od-ui-skills` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/ui-skills`.
