...
> Codex import: this local copy is namespaced as `od-design-md` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/design-md`.
