...
> Codex import: this local copy is namespaced as `od-social-x-post-card` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/social-x-post-card`.
