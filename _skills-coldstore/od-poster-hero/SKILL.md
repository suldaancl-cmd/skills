...
> Codex import: this local copy is namespaced as `od-poster-hero` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/poster-hero`.
