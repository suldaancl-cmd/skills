...
> Codex import: this local copy is namespaced as `od-fal-generate` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/fal-generate`.
