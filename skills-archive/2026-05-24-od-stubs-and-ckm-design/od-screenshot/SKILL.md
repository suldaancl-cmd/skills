...
> Codex import: this local copy is namespaced as `od-screenshot` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/screenshot`.
