...
> Codex import: this local copy is namespaced as `od-card-xiaohongshu` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/card-xiaohongshu`.
