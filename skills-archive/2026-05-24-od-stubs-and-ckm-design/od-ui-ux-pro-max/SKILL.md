...
> Codex import: this local copy is namespaced as `od-ui-ux-pro-max` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/ui-ux-pro-max`.
