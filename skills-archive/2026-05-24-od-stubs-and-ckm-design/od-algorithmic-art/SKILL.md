...
> Codex import: this local copy is namespaced as `od-algorithmic-art` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/algorithmic-art`.
