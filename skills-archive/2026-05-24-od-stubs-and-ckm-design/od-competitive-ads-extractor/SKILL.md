---
name: od-competitive-ads-extractor
description: |
...
> Codex import: this local copy is namespaced as `od-competitive-ads-extractor` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/competitive-ads-extractor`.
