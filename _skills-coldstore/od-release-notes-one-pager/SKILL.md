...
> Codex import: this local copy is namespaced as `od-release-notes-one-pager` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/release-notes-one-pager`.
