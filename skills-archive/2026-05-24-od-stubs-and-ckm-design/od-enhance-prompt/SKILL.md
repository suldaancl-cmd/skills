...
> Codex import: this local copy is namespaced as `od-enhance-prompt` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/enhance-prompt`.
