...
> Codex import: this local copy is namespaced as `od-minimax-pdf` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/minimax-pdf`.
