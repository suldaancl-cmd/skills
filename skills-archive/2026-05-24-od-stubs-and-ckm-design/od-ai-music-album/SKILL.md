...
> Codex import: this local copy is namespaced as `od-ai-music-album` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/ai-music-album`.
