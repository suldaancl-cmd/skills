---
name: od-flutter-animating-apps
description: |
...
> Codex import: this local copy is namespaced as `od-flutter-animating-apps` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/flutter-animating-apps`.
