...
> Codex import: this local copy is namespaced as `od-artifacts-builder` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/artifacts-builder`.
