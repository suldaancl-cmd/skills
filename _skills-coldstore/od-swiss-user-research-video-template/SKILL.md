---
name: od-swiss-user-research-video-template
description: |
...
> Codex import: this local copy is namespaced as `od-swiss-user-research-video-template` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/swiss-user-research-video-template`.
