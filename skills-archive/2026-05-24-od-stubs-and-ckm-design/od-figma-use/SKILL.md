...
> Codex import: this local copy is namespaced as `od-figma-use` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/figma-use`.
