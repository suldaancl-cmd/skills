...
> Codex import: this local copy is namespaced as `od-canvas-design` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/canvas-design`.
