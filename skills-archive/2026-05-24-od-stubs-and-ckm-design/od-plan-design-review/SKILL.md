...
> Codex import: this local copy is namespaced as `od-plan-design-review` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/plan-design-review`.
