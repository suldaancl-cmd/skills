---
name: od-editorial-burgundy-principles-template
description: |
...
> Codex import: this local copy is namespaced as `od-editorial-burgundy-principles-template` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/editorial-burgundy-principles-template`.
