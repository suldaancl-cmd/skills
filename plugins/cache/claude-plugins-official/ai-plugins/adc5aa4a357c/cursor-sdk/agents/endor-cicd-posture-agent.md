...
<!-- endor_agent_kit_managed=true agent_id=cicd-posture agent_name=endor-cicd-posture-agent host=cursor-sdk -->

Generated from Endor Agent Kit recipe `cicd-posture` v0.1.0 for Cursor Python SDK automation.
