---
name: od-weread-year-in-review-video-template
description: |
...
> Codex import: this local copy is namespaced as `od-weread-year-in-review-video-template` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/weread-year-in-review-video-template`.
