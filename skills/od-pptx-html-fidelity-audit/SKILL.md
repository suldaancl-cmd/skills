---
name: od-pptx-html-fidelity-audit
...
> Codex import: this local copy is namespaced as `od-pptx-html-fidelity-audit` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/pptx-html-fidelity-audit`.
