...
> Codex import: this local copy is namespaced as `od-swiftui-design` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/swiftui-design`.
