...
<!-- endor_agent_kit_managed=true agent_id=sca-remediation agent_name=endor-sca-remediation-agent host=cursor-sdk -->

Generated from Endor Agent Kit recipe `sca-remediation` v0.1.0 for Cursor Python SDK automation.
