...
> Codex import: this local copy is namespaced as `od-hatch-pet` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/hatch-pet`.
