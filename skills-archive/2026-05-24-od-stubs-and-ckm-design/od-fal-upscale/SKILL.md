...
> Codex import: this local copy is namespaced as `od-fal-upscale` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/fal-upscale`.
