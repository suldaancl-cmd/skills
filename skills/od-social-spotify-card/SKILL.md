...
> Codex import: this local copy is namespaced as `od-social-spotify-card` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/social-spotify-card`.
