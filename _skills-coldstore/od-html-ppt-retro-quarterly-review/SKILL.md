---
name: od-html-ppt-retro-quarterly-review
description: |
...
> Codex import: this local copy is namespaced as `od-html-ppt-retro-quarterly-review` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/html-ppt-retro-quarterly-review`.
