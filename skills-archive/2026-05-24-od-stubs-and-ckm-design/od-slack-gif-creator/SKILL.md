...
> Codex import: this local copy is namespaced as `od-slack-gif-creator` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/slack-gif-creator`.
