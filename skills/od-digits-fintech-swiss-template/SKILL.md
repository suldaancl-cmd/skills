---
name: od-digits-fintech-swiss-template
description: |
...
> Codex import: this local copy is namespaced as `od-digits-fintech-swiss-template` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/digits-fintech-swiss-template`.
