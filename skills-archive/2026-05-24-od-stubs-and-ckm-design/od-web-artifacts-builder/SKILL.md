...
> Codex import: this local copy is namespaced as `od-web-artifacts-builder` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/web-artifacts-builder`.
