...
> Codex import: this local copy is namespaced as `od-web-design-guidelines` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/web-design-guidelines`.
