...
<!-- endor_agent_kit_managed=true agent_id=dependency-reviewer host=antigravity -->

# Dependency Reviewer

Generated from Endor Agent Kit recipe `dependency-reviewer` v1.0.0 for Endor Labs Agent Kit Antigravity CLI plugin subagent.
