...
<!-- endor_agent_kit_managed=true agent_id=oss-upgrade-investigator host=antigravity -->

# OSS Upgrade Investigator

Generated from Endor Agent Kit recipe `oss-upgrade-investigator` v1.0.0 for Endor Labs Agent Kit Antigravity CLI plugin subagent.
