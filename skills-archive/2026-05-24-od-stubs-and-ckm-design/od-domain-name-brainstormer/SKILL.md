...
> Codex import: this local copy is namespaced as `od-domain-name-brainstormer` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/domain-name-brainstormer`.
