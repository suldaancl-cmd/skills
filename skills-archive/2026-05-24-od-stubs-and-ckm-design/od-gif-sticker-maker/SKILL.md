...
> Codex import: this local copy is namespaced as `od-gif-sticker-maker` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/gif-sticker-maker`.
