...
> Codex import: this local copy is namespaced as `od-frame-logo-outro` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/frame-logo-outro`.
