...
> Codex import: this local copy is namespaced as `od-design-consultation` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/design-consultation`.
