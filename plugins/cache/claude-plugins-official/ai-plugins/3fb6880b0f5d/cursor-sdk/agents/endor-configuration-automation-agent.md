...
<!-- endor_agent_kit_managed=true agent_id=configuration-automation agent_name=endor-configuration-automation-agent host=cursor-sdk -->

Generated from Endor Agent Kit recipe `configuration-automation` v0.1.0 for Cursor Python SDK automation.
