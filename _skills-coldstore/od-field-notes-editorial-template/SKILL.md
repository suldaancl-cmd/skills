---
name: od-field-notes-editorial-template
description: |
...
> Codex import: this local copy is namespaced as `od-field-notes-editorial-template` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/field-notes-editorial-template`.
