...
> Codex import: this local copy is namespaced as `od-shadcn-ui` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/shadcn-ui`.
