...
> Codex import: this local copy is namespaced as `od-youtube-clipper` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/youtube-clipper`.
