...
> Codex import: this local copy is namespaced as `od-frontend-skill` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/frontend-skill`.
