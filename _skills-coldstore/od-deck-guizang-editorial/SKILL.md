---
name: od-deck-guizang-editorial
zh_name: "归藏编辑墨水 Deck"
...
> Codex import: this local copy is namespaced as `od-deck-guizang-editorial` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/deck-guizang-editorial`.
