...
> Codex import: this local copy is namespaced as `od-mockup-device-3d` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/mockup-device-3d`.
