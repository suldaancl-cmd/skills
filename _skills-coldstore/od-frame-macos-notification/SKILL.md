---
name: od-frame-macos-notification
zh_name: "macOS 通知横幅"
...
> Codex import: this local copy is namespaced as `od-frame-macos-notification` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/frame-macos-notification`.
