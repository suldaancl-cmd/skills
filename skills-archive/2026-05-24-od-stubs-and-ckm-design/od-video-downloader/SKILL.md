...
> Codex import: this local copy is namespaced as `od-video-downloader` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/video-downloader`.
