---
name: endor-troubleshooting-agent
description: |
...
<!-- endor_agent_kit_managed=true agent_id=troubleshooting agent_name=endor-troubleshooting-agent host=cursor -->

# Troubleshooting

Generated from Endor Agent Kit recipe `troubleshooting` v0.1.0 for the Endor Labs Agent Kit Cursor plugin agent.
Treat this as a source-first generated artifact; update the recipe and
republish instead of hand-editing installed copies.

This plugin also ships the matching support skill `skills/troubleshooting/`.
