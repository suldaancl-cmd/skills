...
> Codex import: this local copy is namespaced as `od-full-page-screenshot` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/full-page-screenshot`.
