...
> Codex import: this local copy is namespaced as `od-stitch-loop` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/stitch-loop`.
