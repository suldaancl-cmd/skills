...
> Codex import: this local copy is namespaced as `od-agent-browser` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/agent-browser`.
