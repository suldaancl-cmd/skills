...
> Codex import: this local copy is namespaced as `od-resume-modern` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/resume-modern`.
