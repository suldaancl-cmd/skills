---
name: od-tpl-html-ppt-obsidian-claude-gradient
description: GitHub 暗紫渐变 deck — GitHub-dark #0d1117 + 紫蓝 radial 环境光 + 60px 网格 mask、居中布局、紫色 pill 标签、紫色同色系渐变点缀（#a855f7→#7c5cff，限 pill/标签，不用于大标题）、GitHub 风代码 palette、紫色左边框高亮块。适合开发者工作流 / MCP / Agent / dev tool 教程，类似 GitHub Blog / Linear Changelog。
triggers:
  - "github dark"
  - "developer tutorial"
  - "mcp tutorial"
...
od:
  ...
  speaker_notes: true
  animations: true
  example_prompt: "用 html-ppt-obsidian-claude-gradient 模板做一份开发者教程 PPT。GitHub 暗紫渐变 + 居中布局 + 紫色 pill + 紫色同色系渐变点缀 + 配置/步骤代码块。先确认：教什么、目标受众、要不要 MCP/Agent 配置示例。"
---
