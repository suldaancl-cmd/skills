...
<!-- endor_agent_kit_managed=true agent_id=dependency-reviewer agent_name=endor-dependency-reviewer-agent host=cursor-sdk -->

Generated from Endor Agent Kit recipe `dependency-reviewer` v1.0.0 for Cursor Python SDK automation.
