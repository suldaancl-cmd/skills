---
name: od-frame-flowchart-sticky
zh_name: "便利贴流程图帧"
...
> Codex import: this local copy is namespaced as `od-frame-flowchart-sticky` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/frame-flowchart-sticky`.
