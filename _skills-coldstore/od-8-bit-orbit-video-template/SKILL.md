---
name: od-8-bit-orbit-video-template
description: |
...
> Codex import: this local copy is namespaced as `od-8-bit-orbit-video-template` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/8-bit-orbit-video-template`.
