...
> Codex import: this local copy is namespaced as `od-brand-guidelines` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/brand-guidelines`.
