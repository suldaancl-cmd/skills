...
> Codex import: this local copy is namespaced as `od-fal-train` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/fal-train`.
