...
> Codex import: this local copy is namespaced as `od-creative-director` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/creative-director`.
