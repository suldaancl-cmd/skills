---
name: od-frame-light-leak-cinema
zh_name: "胶片漏光电影帧"
...
> Codex import: this local copy is namespaced as `od-frame-light-leak-cinema` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/frame-light-leak-cinema`.
