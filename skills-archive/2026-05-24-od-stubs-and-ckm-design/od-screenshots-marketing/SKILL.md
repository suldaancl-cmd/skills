...
> Codex import: this local copy is namespaced as `od-screenshots-marketing` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/screenshots-marketing`.
