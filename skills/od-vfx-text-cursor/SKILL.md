...
> Codex import: this local copy is namespaced as `od-vfx-text-cursor` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/vfx-text-cursor`.
