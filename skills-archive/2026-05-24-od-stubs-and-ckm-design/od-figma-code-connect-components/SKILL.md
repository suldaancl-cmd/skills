---
name: od-figma-code-connect-components
description: |
...
> Codex import: this local copy is namespaced as `od-figma-code-connect-components` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/figma-code-connect-components`.
