---
name: od-deck-open-slide-canvas
...
> Codex import: this local copy is namespaced as `od-deck-open-slide-canvas` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/deck-open-slide-canvas`.
