---
name: endor-configuration-automation-agent
description: |
...
<!-- endor_agent_kit_managed=true agent_id=configuration-automation agent_name=endor-configuration-automation-agent host=cursor -->

# Configuration Automation

Generated from Endor Agent Kit recipe `configuration-automation` v0.1.0 for the Endor Labs Agent Kit Cursor plugin agent.
Treat this as a source-first generated artifact; update the recipe and
republish instead of hand-editing installed copies.

This plugin also ships the matching support skill `skills/configuration-automation/`.
