...
> Codex import: this local copy is namespaced as `od-frame-liquid-bg-hero` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/frame-liquid-bg-hero`.
