...
<!-- endor_agent_kit_managed=true agent_id=cicd-posture host=antigravity -->

# CI/CD And Supply Chain Posture

Generated from Endor Agent Kit recipe `cicd-posture` v0.1.0 for Endor Labs Agent Kit Antigravity CLI plugin subagent.
