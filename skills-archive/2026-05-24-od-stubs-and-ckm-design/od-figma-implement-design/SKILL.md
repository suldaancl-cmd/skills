---
name: od-figma-implement-design
description: |
...
> Codex import: this local copy is namespaced as `od-figma-implement-design` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/figma-implement-design`.
