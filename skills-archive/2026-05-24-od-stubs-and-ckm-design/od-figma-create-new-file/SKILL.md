...
> Codex import: this local copy is namespaced as `od-figma-create-new-file` to avoid collisions with existing skills. Upstream source: `nexu-io/open-design/skills/figma-create-new-file`.
